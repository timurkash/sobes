...
type CreateOrderRequest struct {
	...
	HotelId   string                 `protobuf:"bytes,1,opt,name=hotel_id,proto3" json:"hotel_id,omitempty"`
	RoomId    string                 `protobuf:"bytes,2,opt,name=room_id,proto3" json:"room_id,omitempty"`
	UserEmail string                 `protobuf:"bytes,3,opt,name=user_email,json=email,proto3" json:"user_email,omitempty"`
...
func (x *CreateOrderRequest) GetHotelId() string {
	if x != nil {
		return x.HotelId
	}
	return ""
...
func (x *CreateOrderRequest) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
var file_helloworld_v1_greeter_proto_rawDesc = []byte{
	...
	,
	...
	0x70, 0x6c, 0x79, 0x32, 0x70, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x65,
	...
	0x79, 0x22, 0x12, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0c, 0x3a, 0x01, 0x2a, 0x22, 0x07, 0x2f, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x73, 0x42, 0x21, 0x5a, 0x1f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f,
...
var file_helloworld_v1_greeter_proto_goTypes = []interface{}{
	(*CreateOrderRequest)(nil),    // 0: helloworld.v1.CreateOrderRequest
	(*CreateOrderReply)(nil),      // 1: helloworld.v1.CreateOrderReply
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_helloworld_v1_greeter_proto_depIdxs = []int32{
	2, // 0: helloworld.v1.CreateOrderRequest.from:type_name -> google.protobuf.Timestamp
	2, // 1: helloworld.v1.CreateOrderRequest.to:type_name -> google.protobuf.Timestamp
	0, // 2: helloworld.v1.Greeter.CreateOrder:input_type -> helloworld.v1.CreateOrderRequest
	1, // 3: helloworld.v1.Greeter.CreateOrder:output_type -> helloworld.v1.CreateOrderReply
