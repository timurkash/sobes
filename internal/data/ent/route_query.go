...
func (rq *RouteQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (rq *RouteQuery) FirstIDX(ctx context.Context) uint64 {
...
func (rq *RouteQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (rq *RouteQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (rq *RouteQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (rq *RouteQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
